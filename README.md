...
**mizumi** currently provides 4 utility classes in the ```miz``` namespace: ```miz::vertex```, ```miz::texture```, ```mix::shader```, and ```miz::mesh```.
These classes manage loading and destroying shaders & programs, textures, and vertex arrays & element buffers respectively.

## Example
![alt text](https://github.com/igozdev/mizumi/blob/main/example.gif)
